function [Path, distanceX, OPEN_num, open, run_time] = Astar_Conventional8(GridMap, St, Ta, diagRule)
% Inputs:
...
%   run_time only measures the main A* search loop.
...
for k = 1:-1:-1
    for j = 1:-1:-1
        ...
        exp_array(exp_count,5) = exp_array(exp_count,3) + exp_array(exp_count,4); % f
    end
end
end
